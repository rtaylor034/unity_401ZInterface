...
namespace GExtensions
{
    ...
    public static class DelegatesEXT
    {
        /// <summary>
        /// [Shorthand] <br></br>
    ...
    public static class BooleanLogicEXT
    {
    ...
    public static class ResultOptionEXT
    {
        public static GStructures.Result<T, E> AsOk<T, E>(this T value) => new GStructures.Result<T, E>.Ok(value);
    }
}